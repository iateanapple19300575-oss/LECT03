...
Public Class ImporterGenerator
    ...
    Public Shared Function GenerateImporter(tableName As String,
        ...
        sb.AppendLine("        Get")
        sb.AppendLine(String.Format("            Return ""{0}""", importTypeName))
        sb.AppendLine("        End Get")
        sb.AppendLine("    End Property")
        sb.AppendLine()
        sb.AppendLine("    Protected Overrides Function GetDtoType() As Type")
        sb.AppendLine(String.Format("        Return GetType({0})", dtoClassName))
        sb.AppendLine("    End Function")
        sb.AppendLine()
        sb.AppendLine("    Protected Overrides Function MapRow(row As DataRow) As Object")
        sb.AppendLine(String.Format("        Return New {0} With {{", dtoClassName))
        ...
        For i As Integer = 0 To schema.Rows.Count - 1
            ...
            sb.AppendLine(String.Format("            .{0} = {1}(row(""{0}"")){2}", colName, castFunc, comma))
        Next
